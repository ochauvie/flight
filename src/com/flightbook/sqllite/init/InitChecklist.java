...
public final class InitChecklist  {
	...
	public static void initChecklist(SQLiteDatabase db) {
	...
	private static void initArcus(SQLiteDatabase db) {
		// Arcus
	...
	private static void initArducopter(SQLiteDatabase db) {
		...
		values = new ContentValues();
		values.put(DbManager.COL_NAME, "Arducopter");
		values.put(DbManager.COL_ACTION, "Télémétrie OK");
		values.put(DbManager.COL_ORDER, 2);
		db.insert(DbManager.TABLE_CHECKLIST, null, values);

		values = new ContentValues();
		values.put(DbManager.COL_NAME, "Arducopter");
		values.put(DbManager.COL_ACTION, "Nombre de satellites OK");
		values.put(DbManager.COL_ORDER, 3);
		db.insert(DbManager.TABLE_CHECKLIST, null, values);

		values = new ContentValues();
		values.put(DbManager.COL_NAME, "Arducopter");
		values.put(DbManager.COL_ACTION, "Batterie OK");
		values.put(DbManager.COL_ORDER, 4);
		db.insert(DbManager.TABLE_CHECKLIST, null, values);

		values = new ContentValues();
		values.put(DbManager.COL_NAME, "Arducopter");
		values.put(DbManager.COL_ACTION, "Armement");
		values.put(DbManager.COL_ORDER, 5);
		db.insert(DbManager.TABLE_CHECKLIST, null, values);
